...
class DrawView: UIView, UIGestureRecognizerDelegate {
    ...
    func indexOfLine(at point: CGPoint) -> Int? {
        ...
        // If nothing is close enough to tapped point, then we did not select a line 
        return nil
    }
    ...
    func moveLine(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        if let index = selectedLineIndex {
            ...
            if gestureRecognizer.state == .changed {
                ...
                // Make sure ther are no copy and paste typos!
    ...
    func tap(_ gestureRegonizer: UIGestureRecognizer) {
        print("Recognized a top")
        
        let point = gestureRegonizer.location(in: self)
        selectedLineIndex = indexOfLine(at: point)
